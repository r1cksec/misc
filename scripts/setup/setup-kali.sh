...
echo "Set default search engine DuckDuck Go"
echo "Set Home Page to blank"
echo "Set strict cookies and never remember history "
echo ""
...
echo "echo 'sudo ip a add 192.168.56.111/24 dev eth1 >> '${homeDir}/config/config-ip.sh'"
